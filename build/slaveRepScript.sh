...
#TODO before doing PutMasterIntoBackupMode clean up archive logs (IE rm or mv /var/lib/postgresql/10/archive/*). They are not needed since we are effectivly createing a new base backup and then synching it. 
